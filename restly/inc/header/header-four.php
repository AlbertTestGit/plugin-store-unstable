...
$restly_show_top_header4 = restly_options('restly_show_top_header4');
...
<header id="masthead" class="site-header header-three header-four">
	<?php if($restly_show_top_header4 == true ) : ?>
		...
		<div class="container">
			<nav class="navbar navbar-expand-lg navbar-light main-navigation" id="site-navigation">
				<div class="logo-area">
					<div class="site-branding">
						...
						if(!empty(is_array($restlyMeta) && array_key_exists('restly_meta_select_logo', $restlyMeta)) && $restlyMeta['restly_meta_select_logo'] == true && !empty($restlyMeta['restly_meta_logo']['url'])){
							...
							$restly_ShowLogo = restly_options('restly_show_hlogo4');
							$restly_logo = restly_options('restly_logo4');
				...
				<div class="navbar-collapse nav-menu stellarnav">
					...
					?>
					<?php if(restly_options('restly_show_search4') == '1'){
						get_template_part('inc/header/search','button');
					}?>
					<?php if($restly_show_cta3 == true ){
