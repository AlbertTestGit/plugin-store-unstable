...
CSF::createSection( $restlyThemeOption, array(
    ...
    'fields' => array(
        ...
        array(
            'type'    => 'subheading',
            'content' => esc_html__( 'Header Menu Typography', 'restly' ),
        ),
        array(
            'id'           => 'restly_header_menu_typo',
            'type'         => 'typography',
            'title'        => esc_html__( 'Header Menu', 'restly' ),
            'output'       => '.main-navigation ul li a',
            'extra_styles' => true,
            'color' => false,
            'subtitle'     => esc_html__( 'Set Header Nav Menu typography.', 'restly' ),
        ),
        array(
            'id'           => 'restly_header_smenu_typo',
            'type'         => 'typography',
            'title'        => esc_html__( 'Header Sub Menu', 'restly' ),
            'output'       => '.main-navigation ul li ul li a',
            'extra_styles' => true,
            'color' => false,
            'subtitle'     => esc_html__( 'Set Header Nav Sub Menu typography.', 'restly' ),
        ),
        array(
            'id'           => 'restly_header_megamenu_typo',
            'type'         => 'typography',
            'title'        => esc_html__( 'Header Mega Menu', 'restly' ),
            'output'       => '.stellarnav.desktop li.mega li li a',
            'extra_styles' => true,
            'color' => false,
            'subtitle'     => esc_html__( 'Set Header Nav Mega Menu typography.', 'restly' ),
        ),
    ),
) );
